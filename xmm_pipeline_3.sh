...
# -- CCDs --
M1_CCDS=$(get_ccds "${MOS1_CCDS_CLI:-}" EXCLUDE_CCDS_M1 "$CCDS_ENV_FILE" m1)
M2_CCDS=$(get_ccds "${MOS2_CCDS_CLI:-}" EXCLUDE_CCDS_M2 "$CCDS_ENV_FILE" m2)
PN_CCDS=$(get_ccds "${PN_CCDS_CLI:-}" EXCLUDE_CCDS_PN "$CCDS_ENV_FILE" pn)
